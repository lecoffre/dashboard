"""
Django settings for site_dashboard_django project.
...
SECRET_KEY = 'django-insecure-f-5zp0cn85ob^k5dzimj_^h5^8#lp7usnprw_4k-goc*6!y(2f'
...
ROOT_URLCONF = 'site_dashboard_django.urls'
...
WSGI_APPLICATION = 'site_dashboard_django.wsgi.application'
